"""Shared fixtures for T19 Settings page UI tests.

Mirrors the real-OPA pattern used by tests/T15_scenarios_ui through
tests/T18_audit_ui: a real `opa` binary is started against the real
policy/data bundle so these acceptance tests exercise the real settings
store + pipeline + OPA path, not hand-written decision logic.
"""
