...
- **Files:** `app/schemas/action.py`, `context.py`, `evidence.py`, `decision.py`, `audit.py`
...
- **Files:** `scenarios/scenarios.py`, `app/pep/agent_simulator.py`, `app/pep/sdk_wrapper.py`
...
- **Depends on:** T03
- **Spec refs:** §5.1
- **Files:** `app/normaliser/normaliser.py`
...
- **Depends on:** T04
- **Spec refs:** §5.2, §7
- **Files:** `app/context/fixtures.py`, `app/context/resolver.py`
...
- **Files:** `app/semantic/presidio_sensor.py`
...
- **Files:** `app/semantic/nuance_stub.py`, `app/semantic/evidence_builder.py`
...
- **Depends on:** T02, T08
- **Spec refs:** §6, §5.4, §3
- **Files:** `opa/data/controls.json`, `app/policy/opa_client.py`, `opa/policies/common.rego` (trivial version)
...
- **Files:** `opa/policies/payment.rego`, `opa/policies/email.rego`, `opa/policies/common.rego`
...
- **Files:** `app/enforcement/handler.py`, `app/enforcement/approval_queue.py`
...
- **Files:** `app/audit/models.py`, `app/audit/store.py`
...
- **Depends on:** T03–T12
- **Spec refs:** §11, §12
- **Files:** `app/pipeline.py`, `app/web/routes.py` (JSON endpoint only for now)
...
- **Files:** `app/web/templates/base.html`, `dashboard.html`, `app/web/static/` (minimal), routes for `/`
...
- **Files:** `app/web/templates/scenarios.html`, `decision.html`, routes
...
- **Files:** `app/web/templates/approvals.html`, routes
...
- **Depends on:** T14
- **Spec refs:** §8A item 5
- **Files:** `app/web/templates/record.html`, routes (can run parallel to T15/T16)
...
- **Files:** `app/web/templates/audit.html`, routes
...
- **Files:** `app/web/templates/settings.html`, routes
