"""Shared fixtures for T15 scenario runner / decision view tests.

Mirrors the real-OPA pattern used by tests/T13_pipeline and tests/T14_dashboard:
a real `opa` binary is started against the real policy/data bundle so these
acceptance tests exercise the actual policy decisions, not a mock.
"""
