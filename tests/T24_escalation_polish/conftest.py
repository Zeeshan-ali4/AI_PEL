"""Shared fixtures for T24 escalation-dashboard-polish tests.

Mirrors the real-OPA pattern used by tests/T16_approvals_ui: a real `opa`
binary is started against the real policy/data bundle so these acceptance
tests exercise the actual policy decisions and the real append-only audit
store, not mocks.
"""
